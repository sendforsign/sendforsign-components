...
export const addBlotClass = (index: number) => {
	switch (index) {
		case 1:
			...
			FluentEditor.register(PlaceholderBlot1);
			...
			FluentEditor.register(Fullname1);
			...
			FluentEditor.register(Initials1);
			break;
		case 2:
			...
			FluentEditor.register(PlaceholderBlot2);
			...
			FluentEditor.register(Fullname2);
			...
			FluentEditor.register(Initials2);
			break;
		case 3:
			...
			FluentEditor.register(PlaceholderBlot3);
			...
			FluentEditor.register(Fullname3);
			...
			FluentEditor.register(Initials3);
			break;
		case 4:
			...
			FluentEditor.register(PlaceholderBlot4);
			...
			FluentEditor.register(Fullname4);
			...
			FluentEditor.register(Initials4);
			break;
		case 5:
			...
			FluentEditor.register(PlaceholderBlot5);
			...
			FluentEditor.register(Fullname5);
			...
			FluentEditor.register(Initials5);
			break;
		case 6:
			...
			FluentEditor.register(PlaceholderBlot6);
			...
			FluentEditor.register(Fullname6);
			...
			FluentEditor.register(Initials6);
			break;
		case 7:
			...
			FluentEditor.register(PlaceholderBlot7);
			...
			FluentEditor.register(Fullname7);
			...
			FluentEditor.register(Initials7);
			break;
		case 8:
			...
			FluentEditor.register(PlaceholderBlot8);
			...
			FluentEditor.register(Fullname8);
			...
			FluentEditor.register(Initials8);
			break;
		case 9:
			...
			FluentEditor.register(PlaceholderBlot9);
			...
			FluentEditor.register(Fullname9);
			...
			FluentEditor.register(Initials9);
			break;
		case 10:
			...
			FluentEditor.register(PlaceholderBlot10);
			...
			FluentEditor.register(Fullname10);
			...
			FluentEditor.register(Initials10);
			break;
		case 11:
			...
			FluentEditor.register(PlaceholderBlot11);
			...
			FluentEditor.register(Fullname11);
			...
			FluentEditor.register(Initials11);
			break;
		case 12:
			...
			FluentEditor.register(PlaceholderBlot12);
			...
			FluentEditor.register(Fullname12);
			...
			FluentEditor.register(Initials12);
			break;
		case 13:
			...
			FluentEditor.register(PlaceholderBlot13);
			...
			FluentEditor.register(Fullname13);
			...
			FluentEditor.register(Initials13);
			break;
		case 14:
			...
			FluentEditor.register(PlaceholderBlot14);
			...
			FluentEditor.register(Fullname14);
			...
			FluentEditor.register(Initials14);
			break;
		case 15:
			...
			FluentEditor.register(PlaceholderBlot15);
			...
			FluentEditor.register(Fullname15);
			...
			FluentEditor.register(Initials15);
			break;
		case 16:
			...
			FluentEditor.register(PlaceholderBlot16);
			...
			FluentEditor.register(Fullname16);
			...
			FluentEditor.register(Initials16);
			break;
		case 17:
			...
			FluentEditor.register(PlaceholderBlot17);
			...
			FluentEditor.register(Fullname17);
			...
			FluentEditor.register(Initials17);
			break;
		case 18:
			...
			FluentEditor.register(PlaceholderBlot18);
			...
			FluentEditor.register(Fullname18);
			...
			FluentEditor.register(Initials18);
			break;
		case 19:
			...
			FluentEditor.register(PlaceholderBlot19);
			...
			FluentEditor.register(Fullname19);
			...
			FluentEditor.register(Initials19);
			break;
		case 20:
			...
			FluentEditor.register(PlaceholderBlot20);
			...
			FluentEditor.register(Fullname20);
			...
			FluentEditor.register(Initials20);
			break;
		case 21:
			...
			FluentEditor.register(PlaceholderBlot21);
			break;
		case 22:
			...
			FluentEditor.register(PlaceholderBlot22);
			break;
		case 23:
			...
			FluentEditor.register(PlaceholderBlot23);
			break;
		case 24:
			...
			FluentEditor.register(PlaceholderBlot24);
			break;
		case 25:
			...
			FluentEditor.register(PlaceholderBlot25);
			break;
		case 26:
			...
			FluentEditor.register(PlaceholderBlot26);
			break;
		case 27:
			...
			FluentEditor.register(PlaceholderBlot27);
			break;
		case 28:
			...
			FluentEditor.register(PlaceholderBlot28);
			break;
		case 29:
			...
			FluentEditor.register(PlaceholderBlot29);
			break;
		case 30:
			...
			FluentEditor.register(PlaceholderBlot30);
			break;
		case 31:
			...
			FluentEditor.register(PlaceholderBlot31);
			break;
		case 32:
			...
			FluentEditor.register(PlaceholderBlot32);
			break;
		case 33:
			...
			FluentEditor.register(PlaceholderBlot33);
			break;
		case 34:
			...
			FluentEditor.register(PlaceholderBlot34);
			break;
		case 35:
			...
			FluentEditor.register(PlaceholderBlot35);
			break;
		case 36:
			...
			FluentEditor.register(PlaceholderBlot36);
			break;
		case 37:
			...
			FluentEditor.register(PlaceholderBlot37);
			break;
		case 38:
			...
			FluentEditor.register(PlaceholderBlot38);
			break;
		case 39:
			...
			FluentEditor.register(PlaceholderBlot39);
			break;
		case 40:
			...
			FluentEditor.register(PlaceholderBlot40);
			break;
	}
};
...
export const convertBlobImagesInHtml = async (
	html: string
): Promise<string> => {
	const parser = new DOMParser();
	const doc = parser.parseFromString(html, 'text/html');
