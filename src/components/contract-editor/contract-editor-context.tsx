...
export type TContractEditorContextType = {
	...
	refreshPagePlaceholders: string[];
	setRefreshPagePlaceholders: (refreshPagePlaceholders: string[]) => void;
	...
	aiVisible: boolean;
	setAiVisible: (aiVisible: boolean) => void;
	aiHidden: boolean;
	setAiHidden: (aiHidden: boolean) => void;
	isPdf: boolean;
